  ...
  return (
    <div id="bg-case" className="w-full pb-12 bg-gray-900 text-white">
      ...
      <section className="text-[18px] text-justify md:flex flex-col text-white px-[20px] md:px-[160px] lg:px-[200px] mt-[50px] space-y-10">
        ...
        <h2 className="text-3xl font-bold mb-2">Sejarah dan Pengenalan HTML</h2>
        <p className="leading-8">
          ...
          Namun, Berners-Lee tetap berusaha dengan tekadnya agar bisa terwujud.
          Di catatan pribadinya dia bahkan sudah membayangkan bagaimana
          hypertext dapat digunakan, salah satunya bisa digunakan untuk berbagai
          hal, seperti menghubungkan informasi di dalam dokumen secara online
          lebih mudah. Akhirnya pada akhir tahun 1991 HTML resmi disebar ke
          publik.
        </p>
        <p className="leading-8 mt-4">
          HyperText Markup Language (HTML) adalah bahasa standar yang digunakan
          untuk membangun struktur dasar halaman web. Berbeda dengan bahasa
          pemograman umumnya, yang berfokus pada logika atau perhitungan
          melainkan HTML berfokus pada penanda dan markup yang memberi tahu
          browser bagaimana konten, seperti teks atau gambar, harus ditampilkan
          di layar.
        </p>
        <p className="leading-8 mt-4">
          HTML bekerja menggunakan elemen-elemen yang disebut “tag”, seperti tag
          untuk heading, paragraf, tautan gambar, dan lain-lain. Tag ini
        ...
        <h2 className="text-3xl font-bold mb-2">Struktur HTML</h2>
        <p className="leading-8">
        ...
        <ol className="list-decimal pl-8 space-y-4">
          <li>
            ...
            <ul className="list-disc pl-8">
              ...
              <li>
                <code>&lt;title&gt;...&lt;/title&gt;</code> untuk judul halaman.
              </li>
            </ul>
            ...
            <pre className="bg-card p-4 rounded-lg mt-2 border-gray-300">
          ...
          <li>
            ...
            <ul className="list-disc pl-8">
              ...
              <li>Atribut (kalau ada), yang biasanya nempel di tag pembuka.</li>
            </ul>
          ...
          <li>
            ...
            <br />
            Adalah data tambahan untuk tag atau elemen. Walaupun tidak semua tag
            memiliki atribut, ada beberapa yang membutuhkan sebuah atribut
        ...
        <h2 className="text-3xl font-bold mb-2">Kelebihan HTML</h2>
        ...
        <h2 className="text-3xl font-bold mb-2">Kekurangan HTML</h2>
        <ul className="list-disc pl-8 space-y-2">
          <li>Banyak elemen yang harus diulang</li>
          <li>Fitur yang baru terkadang tidak bisa digunakan</li>
          <li>
            HTML digunakan untuk halaman web statis, sementara fitur interaktif
            memerlukan dukungan dari Javascript dll
          </li>
        </ul>
        <h2 className="text-3xl font-bold mb-2">Tips Belajar HTML</h2>
        <ul className="list-decimal pl-8 space-y-2">
          ...
          <p>
            Ada beberapa Editor Teks tapi kamu cari yang paling mudah digunakan,
            seperti Visual Studio Code. Karena visual studio code mempunyai
            beberapa extension yang bisa memudahkan untuk kamu.
          </p>
